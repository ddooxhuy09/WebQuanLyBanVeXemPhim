  ...
  <body>
      ...
      <div class="success-container">
        <div class="success-left">
          <div class="success-message">
            <i class="fas fa-check-circle"></i> Thanh toán thành công! Cảm ơn
            bạn đã đặt vé tại Galaxy Cinema.
          </div>
          <div class="booking-details">
            <h3>Chi tiết đặt vé</h3>
            <p class="highlight">
              <strong>Ghế đã chọn:</strong> ${selectedSeats}
            </p>
            ...
            <c:if test="${not empty phuThuList}">
              <p class="highlight">
                <strong
                  >Phụ thu (${fn:length(selectedSeats.split(','))} vé):</strong
                >
                <fmt:formatNumber
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        // Xóa thời gian giữ ghế trong sessionStorage
