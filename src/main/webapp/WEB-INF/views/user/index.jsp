...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/user/css/asset/moviecontainer.css?v=1.0" />
        ...
        <c:forEach var="phim" items="${phimList}">
            <div class="movie-item">
                <div class="movie-poster">
                    ...
                    <div class="overlay">
                        <form action="${pageContext.request.contextPath}/movie-detail" method="post" style="display: inline;">
                            <input type="hidden" name="id" value="${phim.maPhim}">
                            <button type="submit" class="buy-ticket">Đặt vé</button>
                        </form>
                    </div>
                </div>
