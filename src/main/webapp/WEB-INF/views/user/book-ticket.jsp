        ...
        <div class="booking-container">
            <div class="booking-left">
                ...
                <div class="seat-quantity-container">
                    <c:forEach var="loaiGhe" items="${loaiGheList}">
                        <div class="seat-quantity">
                            ...
                            <button type="button" onclick="decreaseSeat('seatQuantity-${loaiGhe.maLoaiGhe}', '${loaiGhe.maLoaiGhe}')">-</button>
                            ...
                            <button type="button" onclick="increaseSeat('seatQuantity-${loaiGhe.maLoaiGhe}', '${loaiGhe.maLoaiGhe}')">+</button>
                        </div>
                    </c:forEach>
                </div>
                        ...
                        <div class="seat-row">
                            ...
                            <c:forEach var="ghe" items="${gheList}">
                                <c:if test="${ghe.tenHang eq row}">
                                    ...
                                    <div id="seat-${seatId}" 
                                         class="seat ${ghe.loaiGhe.tenLoaiGhe eq 'Đôi' ? 'double' : ''} ${isPaid ? 'occupied' : isReserved ? 'reserved' : 'available'}"
                                         data-seat-id="${seatId}" 
                                         data-is-paid="${isPaid}"
                ...
                <div class="seat-legend">
                    ...
                    <c:forEach var="loaiGhe" items="${loaiGheList}">
                        <div class="legend-item">
                            <div class="seat-example" style="background-color: ${loaiGhe.mauGhe};"></div>
                            <span>${loaiGhe.tenLoaiGhe}</span>
                        </div>
                    </c:forEach>
                </div>
            </div>
    ...
    <script>
        ...
        let seatQuantities = {
            <c:forEach var="loaiGhe" items="${loaiGheList}" varStatus="status">
                "${loaiGhe.maLoaiGhe}": <c:out value="${seatQuantities != null && seatQuantities[loaiGhe.maLoaiGhe] != null ? seatQuantities[loaiGhe.maLoaiGhe] : 0}" />${status.last ? '' : ','}
            </c:forEach>
        };
